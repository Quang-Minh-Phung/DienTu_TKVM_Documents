...
- [Các giao thức AMBA sử dụng trong kiến trúc SOC](https://github.com/Quang-Minh-Phung/DienTu_TKVM_Documents/tree/main/Tai_Lieu_Tham_Khao/AMBA_protocols): Bạn nên bắt đầu theo thứ tự sau: APB -> ASB -> AHB -> AXI.
...
8. [MEMS-NEMS](https://github.com/Quang-Minh-Phung/DienTu_TKVM_Documents/tree/main/Tai_Lieu_Tham_Khao/MEMS_NEMS): Đây là phần theo chương trình đào tạo cũ của chuyên ngành Điện Tử bên HCMUS 😅, bản thân mình thấy rất có ích trong tư duy công việc nên mình đính kèm nha 😁
